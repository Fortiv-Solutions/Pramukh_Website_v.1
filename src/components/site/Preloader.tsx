    ...
    >
      ...
      <div className="flex items-center justify-between p-6 md:p-10 z-10">
        <div className="flex items-center gap-3 sm:gap-4">
          <svg viewBox="240 0 885 410" className="h-6 w-auto fill-[#AD945E]">
          ...
          <span className="text-[0.82rem] font-semibold uppercase tracking-[0.24em] text-[#33312E] font-serif">
            PRAMUKH GROUP
          </span>
          {variant === "surat" && (
            <>
              <span className="h-3.5 w-px bg-[#AD945E]/50" />
              <span className="text-[0.78rem] font-medium uppercase tracking-[0.24em] text-[#AD945E] font-serif">
                SURAT
              </span>
            </>
          )}
        ...
        <span className="text-[0.68rem] font-medium uppercase tracking-[0.24em] text-[#AD945E] font-serif">
      ...
      <div className="relative mx-auto flex flex-col items-center justify-center z-10 my-auto px-4 text-center">
        ...
        {variant === "one-tapi" ? (
          <div className="mt-8 flex flex-col items-center">
            <div className="flex items-center justify-center gap-5 sm:gap-7">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <span className="mt-1 text-[0.62rem] sm:text-[0.7rem] tracking-[0.32em] text-[#AD945E] font-serif uppercase font-medium">
                  A CLASS OF ITS OWN
                </span>
              </div>
            ...
            <p className="mt-4 text-[0.66rem] sm:text-[0.72rem] font-medium uppercase tracking-[0.32em] text-[#AD945E] font-serif">
          ...
          <div className="mt-8 flex flex-col items-center">
            <div className="flex items-center justify-center gap-5 sm:gap-7">
              ...
              <div className="flex flex-col items-start justify-center">
                <span className="text-2xl sm:text-3xl font-light tracking-[0.28em] text-[#33312E] font-serif uppercase">
                  {subtitle || "SURAT"}
                </span>
                <span className="mt-1 text-[0.62rem] sm:text-[0.7rem] tracking-[0.32em] text-[#AD945E] font-serif uppercase font-medium">
                  DEVELOPMENTS
          ...
          <div className="mt-8 flex flex-col items-center text-center">
            ...
            <p className="mt-2 text-[0.68rem] sm:text-[0.74rem] font-medium uppercase tracking-[0.32em] text-[#AD945E] font-serif">
