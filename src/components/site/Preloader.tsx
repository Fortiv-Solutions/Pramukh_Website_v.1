  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex flex-col items-center justify-center z-10 my-auto">
        ...
        {/* Brand Tagline below Loader Icon matching official logo typography and colors */}
        <h2 className="mt-7 text-2xl sm:text-3xl font-medium uppercase tracking-[0.26em] text-[#33312E] font-serif">
          PRAMUKH
        </h2>
      ...
      <div className="relative z-10 w-full">
        <div className="flex items-end justify-between px-8 md:px-12 pb-8">
          <div className="hidden sm:block text-[0.68rem] font-medium uppercase tracking-[0.28em] text-[#33312E]/75 font-serif">
            SURAT • VAPI • SILVASSA
          </div>
